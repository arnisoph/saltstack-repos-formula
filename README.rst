...
Take a look at older `releases <https://github.com/bechtoldt/saltstack-repos-formula/releases>`_ to get a version that isn't using the formhelper
yet (if any).
...
* add tests
* provider interface (that is os agnostic)
* move basic pkg mgmt to tools formula
